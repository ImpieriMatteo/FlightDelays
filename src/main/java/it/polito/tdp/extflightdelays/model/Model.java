...
public class Model {
	...
	public void creaGrafo(int x) {
		...
		//non devo introdurre tutti i vertici ma solo quelli che rispettano il criterio
	...
	public List<Airport> trovaPercorso(Airport a1, Airport a2){
		...
		BreadthFirstIterator<Airport, DefaultWeightedEdge> it = new BreadthFirstIterator<>(grafo, a1); // gli dico il grafo e il nodo di partenza
		...
		//VISITA DEL GRAFO (in cui subentra il listener)
		while(it.hasNext()) {
			it.next();
		}
		
		//se non è presente almeno uno dei due vertici sicuramentee non avrò un percorso
